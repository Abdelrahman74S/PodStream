...
class Episode(models.Model):
    ...
    duration = models.PositiveIntegerField(help_text= "Duration of the episode in seconds", null=True, blank=True)
    file_size = models.PositiveBigIntegerField(help_text= "Size of the audio file in bytes" , null=True, blank=True)
